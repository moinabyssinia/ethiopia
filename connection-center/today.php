...
<div class="container" style = "padding: 0">
    ...
    <thead>
    <tr>
    <th style="background:#1279be; padding: 5px 15px; font-size: 20px;" width="30%" >Event</th>
    <th style="background:#1279be; padding: 5px 15px; font-size: 20px;" width="30%">Location</th>
    <th style="background:#1279be; padding: 5px 15px; font-size: 20px;" width="30%">Time</th>
    </tr>
    </thead>
    <tbody>
    {% set reg = "" %}
